      ...
      <Container>
        ...
        <Content padder>
          ...
          <Text style={stylesHTML}>
            {this.state.dataTime.time1} - {this.state.dataTime.time2}{" "}
            {this.state.dataTime.unit}
          </Text>
          <Text />
          <Text style={{ fontSize: 20 }}>Water Temperature</Text>
          <Text style={stylesHTML}>
            {this.state.dataTemperature.temperature}{" "}
            {this.state.dataTemperature.unit}
          </Text>
          <Text />
              ...
              renderItem={({ item }) => (
                <View style={{ flex: 1 }}>
                  ...
                  <Image
                    ...
                    style={{ height: 200, width: "100%", margin: 7 }}
                    resizeMode="contain"
                  />
                  <Text />
                </View>
